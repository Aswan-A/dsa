...
void addPolynomials(Term p1[], int n1, Term p2[], int n2, Term result[], int *resultSize);
void multiplyPolynomials(Term p1[], int n1, Term p2[], int n2, Term result[], int *resultSize);
...
int main() {
    ...
    Term addResult[100];
    int addResultSize;
    addPolynomials(pol1, n1, pol2, n2, addResult, &addResultSize);
    printf("Sum: ");
    printPolynomial(addResult, addResultSize);

    Term mulResult[100];
    int mulResultSize;
    multiplyPolynomials(pol1, n1, pol2, n2, mulResult, &mulResultSize);
    printf("Product: ");
    printPolynomial(mulResult, mulResultSize);
    return 0;
}
